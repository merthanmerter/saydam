/**
 * Tek dosyalık şema. `bun run db:migrate` bunu idempotent olarak uygular.
 *
 * Para birimleri her yerde **kuruş** (bigint) olarak tutulur; float yok.
 * Dönem (period) `YYYYMM` biçiminde integer'dır: 202603 → Mart 2026.
 */
